...
export const CommentList: React.FC<CommentListProps> = ({ postId }) => {
  ...
  const {
    ...
    loading,
    error,
  } = useSelector((state: RootState) => state.comments) as CommentsState;
  ...
  const postComments = (comments as Array<Comment & { postId: string }>).filter(
    ...
    <Card>
      <div className="p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900">Comments ({postComments.length})</h3>
        </div>
